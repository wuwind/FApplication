...
//		preferences.edit().putLong(UPDATED_AT + mId, System.currentTimeMillis()).commit();
	...
	private void setIsAbleToPull(MotionEvent event) {
		...
		if (firstChild != null) {
			LinearLayoutManager mLayoutManager = (LinearLayoutManager) listView.getLayoutManager();  
			  
//	            mItemCount = mLayoutManager.getItemCount();  
//	            mLastCompletely = mLayoutManager.findLastCompletelyVisibleItemPosition();
			int firstVisiblePos = mLayoutManager.findFirstVisibleItemPosition();
//			int firstVisiblePos = listView.getLayoutManager().findfgetFirstVisiblePosition();
